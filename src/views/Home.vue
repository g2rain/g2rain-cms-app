    ...
    <el-card class="home-card">
      <template #header>
        <div class="card-header">
          <h2>{{ $t('CMS_HOME_WELCOME', '欢迎使用 CMS 内容管理') }}</h2>
      ...
      <div v-else class="empty-routes">
        <el-empty :description="$t('CMS_HOME_NO_ENTRY', '暂无可用功能入口')" :image-size="100" />
      </div>
    </el-card>
  </div>
</template>
