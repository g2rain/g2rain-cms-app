...
export class ArticleCategoryApi {
   ...
   */
  static async list(params?: ArticleCategoryQuery): Promise<ArticleCategory[]> {
   ...
   * @returns 分页数据
   */
  static async page(params: ArticleCategoryQuery & PageSelectListDto): Promise<PageData<ArticleCategory>> {
    const http = getHttpClient('default');
